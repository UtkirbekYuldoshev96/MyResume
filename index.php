<?php require_once "./forms/data.php"; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <title>MyResume - <?= $name; ?></title>
...
<section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
        <h1 align="right"><?= $name; ?></h1>
        <p align="right">I'm <span class="typed" data-typed-items="Developer, Frontend, Backend, FullStick"></span></p>
        <div class="social-links" align="right">
            <a href="https://github.com/UtkirbekYuldoshev96" target="_blank" class="github"><i
                        class="bx bxl-github"></i></a>
            <a href="https://t.me/U_YuldoshevDev" target="_blank" class="telegram"><i class="bx bxl-telegram"></i></a>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 pt-4 pt-lg-0 content">
                    <h3 class="mb-5 mt-4">Developer : Frontend and Backend</h3>
                    <p class="fst-normal"><?= $about_titul; ?></p>
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            <ul>
                                <!--                  <li><i class="bi bi-chevron-right"></i> <strong>Tug'ilgan kun:</strong> <span>-->
                                <? //=$birthday;?><!--</span></li>-->
                        ...
                        <div class="col-lg-6">
                            <ul>
                                <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span><?= $age; ?></span>
                                </li>
...
<!--                    <p><strong>Maqsadlarim: </strong>-->
<!--                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi consectetur ea eligendi magnam-->
<!--                        quae, qui reiciendis sapiente? Dignissimos eaque ipsa nisi numquam, quia vel! Consectetur.-->
<!--                    </p>-->
                </div>
            </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row skills-content">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="progress">
                        <span class="skill">CSS / Boostrap / TailwandCss / Sass<i class="val">90%</i></span>
                        <div class="progress-bar-wrap">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="progress">
                        <span class="skill">Laravel<i class="val">10%</i></span>
                        <div class="progress-bar-wrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                <input type="email" class="form-control" name="email" id="email"
                                       placeholder="Sizning Elektron Pochtangiz" required>
                            </div>
                        </div>
...
<footer id="footer">
    <div class="container">
        ...
        <div class="copyright">
            &copy; Mualliflik huquqi <strong><span><?= $name; ?></span></strong>. Barcha Huquqlar Himoyalangan
        </div>
    </div>
</footer>
<!-- End Footer -->
